// app/lib/games.ts — datos estáticos tipados (portado de references/templates/data.jsx)
// No hay base de datos ni persistencia: datos en memoria + un generador determinista
// de tablas de puntuaciones (mismo seed → mismas filas, sin Math.random).
...
export function seededScores(seed: number, count = 12): Score[] {
  let s = seed;
