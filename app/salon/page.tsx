...
// app/salon/page.tsx — Salón de la Fama. Tabs por juego que recalculan podio y
// tabla con seededScores (determinista). La fila "TU MEJOR MARCA" solo aparece
...
export default function HallOfFamePage() {
  ...
  const [tab, setTab] = useState<string>(GAMES[0].id);
