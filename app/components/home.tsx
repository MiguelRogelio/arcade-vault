...
// app/components/home.tsx — Home / Landing (ruta "/"): hero con siluetas, "por qué",
// preview de juegos (GAMES), banda de stats, actividad en vivo (ticker estático + top
// jugadores desde seededScores), precios/FAQ y CTA final. Animación de scroll-reveal.

import { useRouter } from "next/navigation";
import { useEffect } from "react";
import { GAMES, seededScores, type Game } from "../lib/games";

// Revela las secciones .reveal cuando entran en viewport (solo cliente).
function useReveal() {
  useEffect(() => {
...
// Feature cards ("¿Por qué Arcade Vault?") — contenido estático del template.
const FEATURES = [
...
// Ticker "últimas puntuaciones" — decorativo estático (fuera de alcance dinámico).
const TICKER = [
...
// Banda de stats — decorativa estática.
const STATS = [
...
export function Home() {
  ...
  // Preview: primeros 6 juegos de GAMES. Top jugadores: 5 filas deterministas.
